...
Route::middleware('auth')->group(function () {
    ...
    Route::post('/items/like/{item_id}',   [LikeController::class, 'create'])->name('likes.create');
    Route::post('/items/unlike/{item_id}', [LikeController::class, 'delete'])->name('likes.delete');

    Route::post('/items/comments/{item_id}', [CommentController::class, 'create'])->name('comments.create');
    ...
    Route::get('/mypage/profile',  [UserController::class, 'profile'])->name('profile.view');
